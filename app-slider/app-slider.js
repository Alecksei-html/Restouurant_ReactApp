...
const AppSlider = () => {
   ...
   <Card.Img variant="top"
    ...
    <Row>
      ...
      <Card.Body>
        ...
        <Link to="/Eventi">
        <Button variant="primary">Scopri di pui</Button>
      </Link>
  ...
  <h2 style={{ textAlign: "center", marginTop:"20px", fontFamily: "font-noto" }}>Piatti popolari</h2>
    <Col sm style={{ textAlign: "center" }}>
    <Card style={{ width: 'auto', textAlign: "center", marginBottom:"10px", fontFamily: "font-noto"}}>
      <Card.Img variant="top" src="https://st4.depositphotos.com/35104258/37955/i/450/depositphotos_379558486-stock-photo-homemade-tortellini-egg-pasta-floured.jpg/100px180" />
      <Card.Body>
        <Card.Title>Ravioli, Tortellini e Agnolotti</Card.Title>
        <Card.Text>
        10 euro
        </Card.Text>
    ...
    <Col sm style={{ textAlign: "center" }}>
    <Card style={{ width: 'auto', textAlign: "center", marginBottom:"10px", fontFamily: "font-noto"}}>
      <Card.Img variant="top" src="https://st3.depositphotos.com/1062035/12668/i/600/depositphotos_126685186-stock-photo-new-york-steak.jpg/100px180" />
      <Card.Body>
        <Card.Title>La Fiorentina</Card.Title>
        <Card.Text>
        35 euro
        </Card.Text>
        {/* <Button href="#" variant="primary">Scopri di pui</Button> */}
    ...
    <Col sm style={{ textAlign: "center" }}>
    <Card style={{ width: 'auto', textAlign: "center", marginBottom:"10px", fontFamily: "font-noto"}}>
      <Card.Img variant="top" src="https://st2.depositphotos.com/7401550/11391/i/450/depositphotos_113918824-stock-photo-mixed-grilled-fish.jpg/100px180" />
      <Card.Body>
        <Card.Title>Fritto Misto</Card.Title>
        <Card.Text>
        14 euro
        </Card.Text>
        {/* <Button href="#" variant="primary">Scopri di pui</Button> */}
    ...
    <Col sm style={{ textAlign: "center" }}>
    <Card style={{ width: 'auto', textAlign: "center", marginBottom:"10px", fontFamily: "font-noto"}}>
      <Card.Img variant="top" src="https://st.depositphotos.com/29411962/60425/i/450/depositphotos_604252574-stock-photo-closeup-slice-tiramisu-scooped-spoon.jpg/100px180" />
      <Card.Body>
        <Card.Title>Tiramisù</Card.Title>
        <Card.Text>
        7 euro
        </Card.Text>
        {/* <Button href="#" variant="primary">Scopri di pui</Button> */}
